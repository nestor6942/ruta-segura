...
Aplicación nativa para Android e iOS diseñada para acompañamiento en trayectos, monitoreo GPS silencioso en segundo plano, botón de pánico SOS de un toque y suscripciones dentro de la app ($120 MXN / año) mediante RevenueCat.
...
- **Suscripciones RevenueCat (`react-native-purchases`)**: Pasarela para App Store y Google Play Store para el plan de $120 MXN anuales.
